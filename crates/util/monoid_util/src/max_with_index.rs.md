...
data:
  ...
  code: "use std::marker::PhantomData;\n\nuse monoid::Monoid;\nuse numeric::bound::BoundedBelow;\n\
    ...
    \ max_value: T,\n    max_index: usize,\n}\n\npub struct MaxWithIndexOperator<T>(PhantomData<fn()\
...
documentation_of: crates/util/monoid_util/src/max_with_index.rs
layout: document
redirect_from:
- /library/crates/util/monoid_util/src/max_with_index.rs
- /library/crates/util/monoid_util/src/max_with_index.rs.html
