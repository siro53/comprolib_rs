...
data:
  ...
  code: "use std::{marker::PhantomData, ops::BitXor};\n\nuse crate::Monoid;\nuse numeric::zero::Zero;\n\
...
documentation_of: crates/traits/monoid/src/bitwise_xor.rs
layout: document
redirect_from:
- /library/crates/traits/monoid/src/bitwise_xor.rs
- /library/crates/traits/monoid/src/bitwise_xor.rs.html
